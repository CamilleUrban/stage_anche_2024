...
# ENTREE : une image
# ginput : bord gauche puis bord droit du l'anche
# SORTIE : coordonnees en pixels des deux points
...
# ENTREE : une image
# ginput : bord gauche puis bord droit de l'anche
# SORTIE : matrice de rotation, image J après rotatio
...
#----------------------------------------------------------------------------------------------------------------------------    
# DETECTION DU PROFIL DE L ANCHE
# ENTREE : image, seuil, coordonnées des bords de l'anche (obtenus avec la fonction "bord_anche" - coord = bord_anche(image))
...
#----------------------------------------------------------------------------------------------------------------------------  
# METTRE POLYNOME DE 2nd DEGRE EN FORME CANONIQUE
...
#---------------------------------------------------------------------------------------------------------------------------- 
# Extraction des coefficients des modèles paramétriques des paraboles sur les raideurs et les orconnées à l'origine
